...
public class ThoughtWorksSimulation {
    ...
    public static String handleSecond(int num) {
        return num % b == 0 ? Buzz : Integer.valueOf(num).toString();
    }

    public static String handleThird(int num) {
        return num % c == 0 ? Whizz : Integer.valueOf(num).toString();
    }
